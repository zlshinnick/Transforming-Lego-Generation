...
def parse_ldr_lines(lines):
    ...
    for line in converted_lines:
        ...
        if len(parts) < 15 or parts[0] != '1':
            continue  # Skip non-part lines or malformed entries
...
def position_accuracy(predicted, ground_truth):
    try:
        ...
        mse = np.median((predicted_positions - ground_truth_positions) ** 2)
        return mse
    except:
        return None
...
def main(checkpoint_dir: str, tokenizer_params_path: str, target_dir: str, csv_filename: str):
